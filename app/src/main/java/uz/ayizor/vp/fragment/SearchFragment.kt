...
import uz.ayizor.vp.activity.DetailsActivity
import uz.ayizor.vp.adapter.ProductsAdapter
import uz.ayizor.vp.adapter.RecentSearchesAdapter
import uz.ayizor.vp.databinding.FragmentSearchBinding
    ...
    private fun inits() {
        ...
        binding.etSearch.setOnKeyListener(object : View.OnKeyListener {
            override fun onKey(v: View?, keyCode: Int, event: KeyEvent): Boolean {
                ...
                uz.ayizor.vp.utils.Logger.e(TAG, keyCode.toString())
                uz.ayizor.vp.utils.Logger.e(TAG, event.toString())
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (dataSnapshot in snapshot.children) {
                        ...
                        uz.ayizor.vp.utils.Logger.e(TAG, product?.product_name.toString())
                        if (product != null) {
